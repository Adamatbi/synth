...
def play_wav():
    ...
    try:
        ...
        def callback(outdata, frames, time, status):
            ...
            left_hand_amplitude = shared.scale_value_to_range(shared.left_hand_height,0.2,0.85) if shared.tracking else 0
            right_hand_amplitude = shared.scale_value_to_range(shared.right_hand_height,0.2,0.85) if shared.tracking else 0
